#To run tests use pytest in terminal or pytest -n (Number of parallel tests)

# Author - Robert Chapin
# Date Created - 5/11/2022
# First test created by playwright, it navigates to default page and clicks button link than navigates back
def test_click(page):
    page.goto("/")
...
# Author - Robert Chapin
# Date Created - 5/11/2022
# This test navigates to the load delay link which takes 15seconds to load and returns
...
# Author - Robert Chapin
# Date Created - 5/11/2022
# This test navigates to the client side delay link which takes 15seconds to load and verifies client data is loaded after the delay
...
# Author - Robert Chapin
# Date Created - 5/11/2022
# This test enters value into a text field and verifies a button is updated with that text
...
# Author - Robert Chapin
# Date Created - 5/11/2022
# This test attempts to log into a page but fails and verifies warning appears
...
# Author - Robert Chapin
# Date Created - 5/11/2022
# This test can click a link which has a non-breaking space inside it between My and Button
